...
public class TestActivity extends Activity implements View.OnClickListener, View.OnLongClickListener {
    ...
    public boolean onLongClick(View v) {
        switch (v.getId()){
            case R.id.test_btn_m_write:
              if(test_btn_m_write.getText().toString().equals("Ğ´Èë")){
                  test_btn_m_write.setText("Í£Ö¹");
                  ...
                  test_btn_m_write.setText("Ğ´Èë");
                  flag_m_write=false;
              }

                break;
            case R.id.test_btn_m_read:
                if(test_btn_m_read.getText().toString().equals("¶Á³ö")){
                    test_btn_m_read.setText("Í£Ö¹");
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
                    ...
                    test_btn_m_read.setText("¶Á³ö");
                    flag_m_read=false;
                }
                break;
            case R.id.test_btn_vw_write:
                if(test_btn_vw_write.getText().toString().equals("Ğ´Èë")){
                    test_btn_vw_write.setText("Í£Ö¹");
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
                    ...
                    test_btn_vw_write.setText("Ğ´Èë");
                    flag_vw_write=false;
                }
                break;
            case R.id.test_btn_vw_read:
                if(test_btn_vw_read.getText().toString().equals("¶Á³ö")){
                    test_btn_vw_read.setText("Í£Ö¹");
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
                    ...
                    test_btn_vw_read.setText("¶Á³ö");
                    flag_vw_read=false;
                }
                break;
            case R.id.test_btn_vd_write:
                if(test_btn_vd_write.getText().toString().equals("Ğ´Èë")){
                    test_btn_vd_write.setText("Í£Ö¹");
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
                    ...
                    test_btn_vd_write.setText("¶Á³ö");
                    flag_vd_write=false;
                }
                break;
            case R.id.test_btn_vd_read:
                if(test_btn_vd_read.getText().toString().equals("¶Á³ö")){
                    test_btn_vd_read.setText("Í£Ö¹");
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
                    ...
                    test_btn_vd_read.setText("¶Á³ö");
                    flag_vd_read=false;
                }
                break;
            case R.id.test_btn_f_write:
                if(test_btn_f_write.getText().toString().equals("Ğ´Èë")){
                    test_btn_f_write.setText("Í£Ö¹");
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
                    ...
                    test_btn_f_write.setText("¶Á³ö");
                    flag_f_write=false;
                }
                break;
            case R.id.test_btn_f_read:
                if(test_btn_f_read.getText().toString().equals("¶Á³ö")){
                    test_btn_f_read.setText("Í£Ö¹");
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
